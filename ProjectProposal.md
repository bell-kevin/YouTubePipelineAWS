...
* **Visualization:** Amazon QuickSight (primary) with backup Plotly Dash notebooks for rapid iteration.
...
Amazon QuickSight | 3 authors (Standard) | $27.00
...
Dec 8–13 | Publish dashboards, conduct QA, finalize report & presentation | QuickSight dashboards wired to curated tables, written analysis chapter, recorded demo
...
* **Descriptive Analytics:**
  ...
  * Category and geography insights: calculate per-category share-of-voice metrics and regionally normalized engagement scores, surfaced via QuickSight heatmaps.
...
* **Operational Analytics:** Build automated Spark jobs that refresh aggregates daily and push summary tables to Athena / QuickSight.
## 7.   Expected Outcomes
