...
\subsection{Regional Engagement Visualizations}
To illustrate how the curated metrics surface regional differences, Figures~\ref{fig:usa-top20}--\ref{fig:gb-top20} plot the top 20 trending videos by total views for the United States, Canada, and Great Britain on a representative ingest date. The distributions demonstrate that view concentration differs by market (e.g., the United States list contains multiple videos above 150 million views, while Canada's long tail falls below 70 million), reinforcing the need to partition data and train models per region.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedUSA.png}
    \caption{Top 20 most viewed trending videos in the United States.}
    \label{fig:usa-top20}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedCA.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedGB.png}
    \caption{Top 20 most viewed trending videos in Great Britain.}
    \label{fig:gb-top20}
\end{figure}

\subsection{Prediction Visualization}
The dashboard also visualizes model outputs by pairing actual view counts with next-day predictions. Figure~\ref{fig:predictions} highlights that the forecasted values closely track the observed counts for representative videos, providing a sanity check that the regression model is calibrated before deployment to the reporting layer.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{predictions.png}
    \caption{Comparison of observed view counts and next-day predictions for sample trending videos.}
