...
\subsection{Regional Most-Viewed Trends and Prediction Snapshot}
Figure~\ref{fig:ca-most-viewed} through Figure~\ref{fig:usa-most-viewed} illustrate the top-performing videos by view count across Canada, Great Britain, and the United States, respectively. These visuals highlight regional differences in genre, engagement, and channel reach that downstream models can exploit. Figure~\ref{fig:predictions-plot} shows a sample prediction plot summarizing expected next-day performance across videos.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedCA.png}
    \caption{Top viewed trending videos in Canada.}
    \label{fig:ca-most-viewed}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedGB.png}
    \caption{Top viewed trending videos in Great Britain.}
    \label{fig:gb-most-viewed}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mostViewedUSA.png}
    \caption{Top viewed trending videos in the United States.}
    \label{fig:usa-most-viewed}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{predictions.png}
    \caption{Sample prediction output summarizing expected next-day performance.}
    \label{fig:predictions-plot}
\end{figure}
